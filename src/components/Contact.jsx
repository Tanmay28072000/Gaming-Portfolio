...
function Contact() {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/in/tanmay-mukherjee-6a2387194/',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-700 dark:text-gray-300 max-w-2xl mx-auto px-4">
            Ready to bring your game ideas to life? Let's discuss your next game project and create something amazing together.
          </p>
        </motion.div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 dark:text-gray-400 leading-relaxed max-w-2xl mx-auto">
              I'm always excited to work on new game projects and collaborate with game studios.
              Whether you need a game developer for your team or want to discuss game development, feel free to reach out!
            </p>
          </motion.div>
